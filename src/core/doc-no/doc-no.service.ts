...
/**
 * Generate next document number based on erp_doc_format.format pattern.
 *
 * Format tokens (mirrors SMLERP22):
 *   @     = formatCode (prefix, เช่น "CN", "IA")
 ...
 *   อื่นๆ = literal
 *
 * Caller ระบุ formatCode + transFlag เสมอ (ไม่มี default — core ไม่รู้จัก domain-specific code)
 */
@Injectable()
